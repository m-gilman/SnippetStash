  ...
  $(document).ready(function() {
    ...
    function createUserRow(userData) {
      ...
      newTr.append("<td> " + userData.Snippets.length + "</td>");
      newTr.append("<td><a href='/snippet?user_id=" + userData.id + "'>Go to Snippets</a></td>");
    //   newTr.append("<td><a href='/cms?user_id=" + userData.id + "'>Create a Snippet</a></td>");
    ...
    function renderEmpty() {
      ...
      alertDiv.text("You must create the User before you can create a Snippet.");
